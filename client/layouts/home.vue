  ...
  <div>
      ...
      <div class="hidden lg:fixed lg:inset-y-0 lg:z-50 lg:flex lg:w-72 lg:flex-col">
          ...
          <div class="flex grow flex-col gap-y-5 overflow-y-auto bg-gray-900 px-6 pb-4">
              <div class="flex h-12 w-24 mt-4 ml-16 rounded-lg pl-2 pr-2 shrink-0 items-center bg-white">
                  <h1>ZeeZee.org</h1>
              </div>
              <br>
                  ...
                  <div class="flex items-center gap-x-4 lg:gap-x-6">
                      ...
                      <Menu as="div" class="relative">
                          <MenuButton class="-m-1.5 flex items-center p-1.5">
                              ...
                              <div class="h-8 w-8 rounded-full bg-gray-400 flex justify-center items-center">
                                  <h1 class="text-center font-extrabold">B</h1>
                              </div>
          ...
          <main class="py-10">
              <div class="px-4 sm:px-6 lg:px-8">
                  ...
                  <div class="h-96 w-22 bg-black relative">
                    <img src="https://img.freepik.com/premium-photo/collage-monkeys-with-different-colors-different-colors_900101-26153.jpg" alt="Monkey" class="object-fit absolute inset-0 w-full h-full">
                  </div>
                  <slot />
              </div>
          </main>
